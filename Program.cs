...
Person 
    p1 = new("Иван", "Кукин", new DateTime(1950, 4, 1), 'м'),
    p2 = new("Людмила", "Кукина", new DateTime(1965, 5, 1), 'ж');
Building
    b1 = new(p1, 1500000, "Зайцева, 17"),
    b2 = new(p2, 1500000, "Зайцева, 17");
Stead //Земельный участок
    s1 = new(p1, 250000, 300),
    s2 = new(p2, 250000, 300),
    s3 = new(p1, 300000, 1000);
Horse 
    horse = new(p1, 20000, "Ромашка", 0, 7, 250);
Car 
    car = new(p1, 10000, "ЗАЗ-965", 0, 27);
SmallShip 
    smallship = new(p1, 25000, "лодка с мотором", 0, 0, 15);
Worker 
    w1 = new(p1.FirstName, p1.LastName, p1.BirthDay, p1.Gender, 30000, 25),
